...
#python main.py --scenario_name Disjoint --num_tasks 10 --name_algo baseline  --dataset Core50 --pretrained_on ImageNet --architecture vgg --fast $@
#python main.py --scenario_name Domain --num_tasks 8 --name_algo baseline  --dataset Core10Lifelong --pretrained_on ImageNet --architecture vgg  --fast $@

python main.py --scenario_name Domain --num_tasks 50 --name_algo baseline  --dataset Core10Mix --pretrained_on ImageNet --architecture resnet --fast $@
