...
python main.py --scenario_name Disjoint --num_tasks 1 --name_algo baseline  --dataset Core50 --batch_size 32 --pretrained_on ImageNet --OutLayer $masked_head --seed $seed --masked --subset $subset
...
python main.py --scenario_name Disjoint --num_tasks 1 --name_algo baseline  --dataset Core50 --batch_size 32 --pretrained_on ImageNet --OutLayer $head --seed $seed --subset $subset
done #list_heads
