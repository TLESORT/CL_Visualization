...
def get_transform(name_dataset, architecture, train="True"):
    list_transform = None
    if name_dataset in ["Core50", "Core10Lifelong", "Core10Mix", 'CUB200', 'AwA2', "Tiny", 'OxfordPet', 'OxfordFlower102', "VLCS", "TerraIncognita"]:
...
def get_model(name_dataset, scenario, pretrained_on, test_label, OutLayer, method, model_dir=None,
    ...
    elif name_dataset in ["Core50", "Core10Lifelong", "Core10Mix", 'CUB200', 'AwA2', "Tiny", 'OxfordPet', 'OxfordFlower102', "VLCS", "TerraIncognita"]:
